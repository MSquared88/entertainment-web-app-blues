...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  flyctl create entertainment-web-app-blues-5ee5
  flyctl create entertainment-web-app-blues-5ee5-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  >
  > ```
  > WARN app flag 'entertainment-web-app-blues-5ee5-staging' does not match app name in config file 'entertainment-web-app-blues-5ee5'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  flyctl postgres create --name entertainment-web-app-blues-5ee5-db
  flyctl postgres attach --postgres-app entertainment-web-app-blues-5ee5-db --app entertainment-web-app-blues-5ee5

  flyctl postgres create --name entertainment-web-app-blues-5ee5-staging-db
  flyctl postgres attach --postgres-app entertainment-web-app-blues-5ee5-staging-db --app entertainment-web-app-blues-5ee5-staging
  ```
